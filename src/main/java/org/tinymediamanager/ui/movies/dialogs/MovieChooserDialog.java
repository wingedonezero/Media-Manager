...
public class MovieChooserDialog extends TmmDialog implements ActionListener {
  ...
  public MovieChooserDialog(Movie movie, int queueIndex, int queueSize) {
    ...
    contentPanel.setLayout(new MigLayout("insets 0 n n n", "[500lp:600lp,grow]", "[][shrink 0][250lp:350lp,grow][shrink 0][][][]"));
    ...
    }
    {
      ...
      contentPanel.add(splitPane, "cell 0 2,grow");
      {
        ...
        panelSearchResults.setLayout(new MigLayout("insets 0", "[350lp:400lp,grow]", "[150lp:300lp,grow]"));
        {
