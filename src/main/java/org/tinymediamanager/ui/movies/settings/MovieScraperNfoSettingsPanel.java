...
class MovieScraperNfoSettingsPanel extends JPanel {
  ...
  private void initComponents() {
    setLayout(new MigLayout("", "[600lp,grow]", "[]"));
    {
      ...
      }
      {
        ...
        panelNfo.add(chckbxDateAdded, "cell 1 13 2 1");

        JLabel lblNfoDatefield = new JLabel(TmmResourceBundle.getString("Settings.dateadded"));
        panelNfo.add(lblNfoDatefield, "flowx,cell 2 14");
        ...
        panelNfo.add(chckbxArtworkUrls, "cell 1 15 2 1");
  ...
  protected void initDataBindings() {
    ...
    autoBinding_11.bind();
    //
    Property movieSettingsBeanProperty_10 = BeanProperty.create("nfoWriteArtworkUrls");
