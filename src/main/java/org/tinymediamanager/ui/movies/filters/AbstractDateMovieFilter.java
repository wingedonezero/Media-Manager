...
/**
 * The class {@link AbstractDateMovieFilter} provides a base implementation for date-based movie filters with various comparison options.
 * <p>
 * Subclasses can use this to filter movies based on date fields with options like less than, greater than, equals, and between.
 * </p>
 *
 * @author Manuel Laggner
 */
public abstract class AbstractDateMovieFilter extends AbstractMovieUIFilter {
